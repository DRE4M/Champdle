...
faq-similarity-description = 유사도는 총 100점 만점(카테고리 7종 80점 + 스탯 18종 20점)을 기준으로 가중치 산출됩니다:
  1. 카테고리 항목 (총 80점 만점 / 희귀도 가중치 반영)
  - 소속 지역 (15점): 14개 지역 중 일치 시 15점 (희귀성 최고 버프)
  - 종족 (15점): 완벽 일치 시 15점, 공통 종족 1개 이상 겹치면 절반 7.5점 (희귀성 최고 버프)
  - 출시 순서 (14점): 1번(애니)부터 173번까지의 순서 격차(Min-Max) 비율로 최대 14점
  - 역할군 1·2 (12점): 주/부 순서·종류 완벽 일치 12점(100%), 주역할만 일치 9.6점(80%), 주/부 교차 8.4점(70%), 부역할 부분 6점(50%)
  - 자원 유형 (10점): 마나/기력/노마나 등 일치 시 10점
  - 공격 방식 (7점) & 성별 (7점): 선택지 수(2~3개)가 적어 각 7점씩 반영
  2. 스탯 항목 (총 20점 / 18종 각 약 1.11점 배점)
  - 이동속도, 사거리, 체력, 마나, 공격력, 방어력, 마저, 재생력 등 18개 능력치 차이를 Min-Max 정규화로 산출합니다.
